...
function cancel(input) {
    ...
    for (var _i = 0, scope_1 = scope; _i < scope_1.length; _i++) {
        ...
        function REQUIRED_MESSAGE_CANCELLATION_REASON_ID(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_16 = scope; _i < scope_16.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_15, "$.message.cancellation_reason_id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function VALID_ENUM_CONTEXT_DOMAIN(input) {
            ...
            for (var _i = 0, scope_17 = scope; _i < scope_17.length; _i++) {
                ...
                var enumList = ["ONDC:LOG10", "ONDC:LOG11", "nic2004:60232"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_16, "$.context.domain");
        ...
        function validate_cancellation_codes_log10(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_18 = scope; _i < scope_18.length; _i++) {
                ...
                var domain = json_path_utils_1.default.getJsonPath(testObj_17, "$.context.domain");
                var p2pCancellationCodes = [
                    "004",
                    "005",
                    "007",
                    "150",
                ...
                var domainList = ["ONDC:LOG10"];
                var cancellationId = json_path_utils_1.default.getJsonPath(testObj_17, "$.message.cancellation_reason_id");
                var skipCheck = !validation_utils_1.default.allIn(domain, domainList);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(cancellationId, p2pCancellationCodes);
                if (!validate) {
        ...
        function validate_cancellation_codes_log11(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_19 = scope; _i < scope_19.length; _i++) {
                ...
                var domain = json_path_utils_1.default.getJsonPath(testObj_18, "$.context.domain");
                var p2h2pCancellationCodes = [
                    "004",
                    "005",
                    "007",
                    "250",
                ...
                var domainList = ["ONDC:LOG11"];
                var cancellationId = json_path_utils_1.default.getJsonPath(testObj_18, "$.message.cancellation_reason_id");
                var skipCheck = !validation_utils_1.default.allIn(domain, domainList);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(cancellationId, p2h2pCancellationCodes);
                if (!validate) {
