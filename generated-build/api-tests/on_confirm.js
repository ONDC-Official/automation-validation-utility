...
function on_confirm(input) {
    ...
    for (var _i = 0, scope_1 = scope; _i < scope_1.length; _i++) {
        ...
        function REQUIRED_MESSAGE_TRACKING(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_31 = scope; _i < scope_31.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_30, "$.message.order.fulfillments[*].tracking");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_NAME(input) {
            ...
            for (var _i = 0, scope_32 = scope; _i < scope_32.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_31, "$.message.order.fulfillments[*].start.person.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_ID_32(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_33 = scope; _i < scope_33.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_32, "$.message.order.fulfillments[*].start.location.id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_ID_32**: $.message.order.fulfillments[*].start.location.id must be present in the payload",
                        },
                    ];
                }
                delete testObj_32._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_GPS(input) {
            ...
            for (var _i = 0, scope_34 = scope; _i < scope_34.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_33, "$.message.order.fulfillments[*].start.location.gps");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_NAME_34(input) {
            ...
            for (var _i = 0, scope_35 = scope; _i < scope_35.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_34, "$.message.order.fulfillments[*].start.location.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_34**: $.message.order.fulfillments[*].start.location.address.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_34._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_BUILDING(input) {
            ...
            for (var _i = 0, scope_36 = scope; _i < scope_36.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_35, "$.message.order.fulfillments[*].start.location.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_LOCALITY(input) {
            ...
            for (var _i = 0, scope_37 = scope; _i < scope_37.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_36, "$.message.order.fulfillments[*].start.location.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CITY(input) {
            ...
            for (var _i = 0, scope_38 = scope; _i < scope_38.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_37, "$.message.order.fulfillments[*].start.location.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_STATE_38(input) {
            ...
            for (var _i = 0, scope_39 = scope; _i < scope_39.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_38, "$.message.order.fulfillments[*].start.location.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_STATE_38**: $.message.order.fulfillments[*].start.location.address.state must be present in the payload",
                        },
                    ];
                }
                delete testObj_38._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_COUNTRY(input) {
            ...
            for (var _i = 0, scope_40 = scope; _i < scope_40.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_39, "$.message.order.fulfillments[*].start.location.address.country");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_AREA_CODE(input) {
            ...
            for (var _i = 0, scope_41 = scope; _i < scope_41.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_40, "$.message.order.fulfillments[*].start.location.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_PHONE(input) {
            ...
            for (var _i = 0, scope_42 = scope; _i < scope_42.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_41, "$.message.order.fulfillments[*].start.contact.phone");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_EMAIL(input) {
            ...
            for (var _i = 0, scope_43 = scope; _i < scope_43.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_42, "$.message.order.fulfillments[*].start.contact.email");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_DURATION_43(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_44 = scope; _i < scope_44.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_43, "$.message.order.fulfillments[*].start.time.duration");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_DURATION_43**: $.message.order.fulfillments[*].start.time.duration must be present in the payload",
                        },
                    ];
                }
                delete testObj_43._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_44(input) {
            ...
            for (var _i = 0, scope_45 = scope; _i < scope_45.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_44, "$.message.order.fulfillments[*].end.person.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_44**: $.message.order.fulfillments[*].end.person.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_44._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_GPS_45(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_46 = scope; _i < scope_46.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_45, "$.message.order.fulfillments[*].end.location.gps");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_GPS_45**: $.message.order.fulfillments[*].end.location.gps must be present in the payload",
                        },
                    ];
                }
                delete testObj_45._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_46(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_47 = scope; _i < scope_47.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_46, "$.message.order.fulfillments[*].end.location.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_46**: $.message.order.fulfillments[*].end.location.address.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_46._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_BUILDING_47(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_48 = scope; _i < scope_48.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_47, "$.message.order.fulfillments[*].end.location.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_BUILDING_47**: $.message.order.fulfillments[*].end.location.address.building must be present in the payload",
                        },
                    ];
                }
                delete testObj_47._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_LOCALITY_48(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_49 = scope; _i < scope_49.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_48, "$.message.order.fulfillments[*].end.location.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_LOCALITY_48**: $.message.order.fulfillments[*].end.location.address.locality must be present in the payload",
                        },
                    ];
                }
                delete testObj_48._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CITY_49(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_50 = scope; _i < scope_50.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_49, "$.message.order.fulfillments[*].end.location.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CITY_49**: $.message.order.fulfillments[*].end.location.address.city must be present in the payload",
                        },
                    ];
                }
                delete testObj_49._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_STATE_50(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_51 = scope; _i < scope_51.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_50, "$.message.order.fulfillments[*].end.location.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_STATE_50**: $.message.order.fulfillments[*].end.location.address.state must be present in the payload",
                        },
                    ];
                }
                delete testObj_50._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_COUNTRY_51(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_52 = scope; _i < scope_52.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_51, "$.message.order.fulfillments[*].end.location.address.country");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_COUNTRY_51**: $.message.order.fulfillments[*].end.location.address.country must be present in the payload",
                        },
                    ];
                }
                delete testObj_51._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_AREA_CODE_52(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_53 = scope; _i < scope_53.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_52, "$.message.order.fulfillments[*].end.location.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_AREA_CODE_52**: $.message.order.fulfillments[*].end.location.address.area_code must be present in the payload",
                        },
                    ];
                }
                delete testObj_52._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_PHONE_53(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_54 = scope; _i < scope_54.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_53, "$.message.order.fulfillments[*].end.contact.phone");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_PHONE_53**: $.message.order.fulfillments[*].end.contact.phone must be present in the payload",
                        },
                    ];
                }
                delete testObj_53._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_54(input) {
            ...
            for (var _i = 0, scope_55 = scope; _i < scope_55.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_54, "$.message.order.billing.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_54**: $.message.order.billing.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_54._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_55(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_56 = scope; _i < scope_56.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_55, "$.message.order.billing.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_55**: $.message.order.billing.address.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_55._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_BUILDING_56(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_57 = scope; _i < scope_57.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_56, "$.message.order.billing.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_BUILDING_56**: $.message.order.billing.address.building must be present in the payload",
                        },
                    ];
                }
                delete testObj_56._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_LOCALITY_57(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_58 = scope; _i < scope_58.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_57, "$.message.order.billing.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_LOCALITY_57**: $.message.order.billing.address.locality must be present in the payload",
                        },
                    ];
                }
                delete testObj_57._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CITY_58(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_59 = scope; _i < scope_59.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_58, "$.message.order.billing.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CITY_58**: $.message.order.billing.address.city must be present in the payload",
                        },
                    ];
                }
                delete testObj_58._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_STATE_59(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_60 = scope; _i < scope_60.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_59, "$.message.order.billing.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_STATE_59**: $.message.order.billing.address.state must be present in the payload",
                        },
                    ];
                }
                delete testObj_59._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_COUNTRY_60(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_61 = scope; _i < scope_61.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_60, "$.message.order.billing.address.country");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_COUNTRY_60**: $.message.order.billing.address.country must be present in the payload",
                        },
                    ];
                }
                delete testObj_60._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_AREA_CODE_61(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_62 = scope; _i < scope_62.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_61, "$.message.order.billing.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_AREA_CODE_61**: $.message.order.billing.address.area_code must be present in the payload",
                        },
                    ];
                }
                delete testObj_61._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_TAX_NUMBER(input) {
            ...
            for (var _i = 0, scope_63 = scope; _i < scope_63.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_62, "$.message.order.billing.tax_number");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_PHONE_63(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_64 = scope; _i < scope_64.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_63, "$.message.order.billing.phone");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_PHONE_63**: $.message.order.billing.phone must be present in the payload",
                        },
                    ];
                }
                delete testObj_63._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_EMAIL_64(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_65 = scope; _i < scope_65.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_64, "$.message.order.billing.email");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_EMAIL_64**: $.message.order.billing.email must be present in the payload",
                        },
                    ];
                }
                delete testObj_64._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CREATED_AT(input) {
            ...
            for (var _i = 0, scope_66 = scope; _i < scope_66.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_65, "$.message.order.billing.created_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_UPDATED_AT(input) {
            ...
            for (var _i = 0, scope_67 = scope; _i < scope_67.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_66, "$.message.order.billing.updated_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_COLLECTED_BY(input) {
            ...
            for (var _i = 0, scope_68 = scope; _i < scope_68.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_67, "$.message.order.payment.collected_by");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_TYPE_68(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_69 = scope; _i < scope_69.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_68, "$.message.order.payment.type");
                var enumList = [
                    "ON-ORDER",
                    "ON-FULFILLMENT",
                    "POST-FULFILLMENT",
        ...
        function REQUIRED_MESSAGE_CATEGORY_ID_69(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_70 = scope; _i < scope_70.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_69, "$.message.order['@ondc/org/linked_order'].items[*].category_id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CATEGORY_ID_69**: $.message.order['@ondc/org/linked_order'].items[*].category_id must be present in the payload",
                        },
                    ];
                }
                delete testObj_69._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_70(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_71 = scope; _i < scope_71.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_70, "$.message.order['@ondc/org/linked_order'].items[*].descriptor.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_70**: $.message.order['@ondc/org/linked_order'].items[*].descriptor.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_70._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_COUNT(input) {
            ...
            for (var _i = 0, scope_72 = scope; _i < scope_72.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_71, "$.message.order['@ondc/org/linked_order'].items[*].quantity.count");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_UNIT(input) {
            ...
            for (var _i = 0, scope_73 = scope; _i < scope_73.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_72, "$.message.order['@ondc/org/linked_order'].items[*].quantity.measure.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_VALUE_73(input) {
            ...
            for (var _i = 0, scope_74 = scope; _i < scope_74.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_73, "$.message.order['@ondc/org/linked_order'].items[*].quantity.measure.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_73**: $.message.order['@ondc/org/linked_order'].items[*].quantity.measure.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_73._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CURRENCY_74(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_75 = scope; _i < scope_75.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_74, "$.message.order['@ondc/org/linked_order'].items[*].price.currency");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CURRENCY_74**: $.message.order['@ondc/org/linked_order'].items[*].price.currency must be present in the payload",
                        },
                    ];
                }
                delete testObj_74._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_75(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_76 = scope; _i < scope_76.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_75, "$.message.order['@ondc/org/linked_order'].items[*].price.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_75**: $.message.order['@ondc/org/linked_order'].items[*].price.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_75._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_76(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_77 = scope; _i < scope_77.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_76, "$.message.order['@ondc/org/linked_order'].provider.descriptor.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_76**: $.message.order['@ondc/org/linked_order'].provider.descriptor.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_76._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_77(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_78 = scope; _i < scope_78.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_77, "$.message.order['@ondc/org/linked_order'].provider.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_77**: $.message.order['@ondc/org/linked_order'].provider.address.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_77._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_BUILDING_78(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_79 = scope; _i < scope_79.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_78, "$.message.order['@ondc/org/linked_order'].provider.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_BUILDING_78**: $.message.order['@ondc/org/linked_order'].provider.address.building must be present in the payload",
                        },
                    ];
                }
                delete testObj_78._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_LOCALITY_79(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_80 = scope; _i < scope_80.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_79, "$.message.order['@ondc/org/linked_order'].provider.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_LOCALITY_79**: $.message.order['@ondc/org/linked_order'].provider.address.locality must be present in the payload",
                        },
                    ];
                }
                delete testObj_79._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CITY_80(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_81 = scope; _i < scope_81.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_80, "$.message.order['@ondc/org/linked_order'].provider.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CITY_80**: $.message.order['@ondc/org/linked_order'].provider.address.city must be present in the payload",
                        },
                    ];
                }
                delete testObj_80._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_STATE_81(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_82 = scope; _i < scope_82.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_81, "$.message.order['@ondc/org/linked_order'].provider.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_STATE_81**: $.message.order['@ondc/org/linked_order'].provider.address.state must be present in the payload",
                        },
                    ];
                }
                delete testObj_81._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_AREA_CODE_82(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_83 = scope; _i < scope_83.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_82, "$.message.order['@ondc/org/linked_order'].provider.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_AREA_CODE_82**: $.message.order['@ondc/org/linked_order'].provider.address.area_code must be present in the payload",
                        },
                    ];
                }
                delete testObj_82._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_ID_83(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_84 = scope; _i < scope_84.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_83, "$.message.order['@ondc/org/linked_order'].order.id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_ID_83**: $.message.order['@ondc/org/linked_order'].order.id must be present in the payload",
                        },
                    ];
                }
                delete testObj_83._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_84(input) {
            ...
            for (var _i = 0, scope_85 = scope; _i < scope_85.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_84, "$.message.order['@ondc/org/linked_order'].order.weight.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_84**: $.message.order['@ondc/org/linked_order'].order.weight.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_84._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_85(input) {
            ...
            for (var _i = 0, scope_86 = scope; _i < scope_86.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_85, "$.message.order['@ondc/org/linked_order'].order.weight.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_85**: $.message.order['@ondc/org/linked_order'].order.weight.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_85._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_86(input) {
            ...
            for (var _i = 0, scope_87 = scope; _i < scope_87.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_86, "$.message.order['@ondc/org/linked_order'].order.dimensions.length.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_86**: $.message.order['@ondc/org/linked_order'].order.dimensions.length.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_86._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_87(input) {
            ...
            for (var _i = 0, scope_88 = scope; _i < scope_88.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_87, "$.message.order['@ondc/org/linked_order'].order.dimensions.length.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_87**: $.message.order['@ondc/org/linked_order'].order.dimensions.length.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_87._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_88(input) {
            ...
            for (var _i = 0, scope_89 = scope; _i < scope_89.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_88, "$.message.order['@ondc/org/linked_order'].order.dimensions.breadth.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_88**: $.message.order['@ondc/org/linked_order'].order.dimensions.breadth.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_88._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_89(input) {
            ...
            for (var _i = 0, scope_90 = scope; _i < scope_90.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_89, "$.message.order['@ondc/org/linked_order'].order.dimensions.breadth.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_89**: $.message.order['@ondc/org/linked_order'].order.dimensions.breadth.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_89._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_90(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_91 = scope; _i < scope_91.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_90, "$.message.order['@ondc/org/linked_order'].order.dimensions.height.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_90**: $.message.order['@ondc/org/linked_order'].order.dimensions.height.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_90._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_91(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_92 = scope; _i < scope_92.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_91, "$.message.order['@ondc/org/linked_order'].order.dimensions.height.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_91**: $.message.order['@ondc/org/linked_order'].order.dimensions.height.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_91._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CREATED_AT_92(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_93 = scope; _i < scope_93.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_92, "$.message.order.created_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CREATED_AT_92**: $.message.order.created_at must be present in the payload",
                        },
                    ];
                }
                delete testObj_92._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UPDATED_AT_93(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_94 = scope; _i < scope_94.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_93, "$.message.order.updated_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UPDATED_AT_93**: $.message.order.updated_at must be present in the payload",
                        },
                    ];
                }
                delete testObj_93._EXTERNAL;
        ...
        function VALID_ENUM_CONTEXT_DOMAIN(input) {
            ...
            for (var _i = 0, scope_95 = scope; _i < scope_95.length; _i++) {
                ...
                var enumList = ["ONDC:LOG10", "ONDC:LOG11", "nic2004:60232"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_94, "$.context.domain");
        ...
        function VALID_ENUM_MESSAGE_STATE(input) {
            ...
            for (var _i = 0, scope_96 = scope; _i < scope_96.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_95, "$.message.order.state");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CATEGORY_ID(input) {
            ...
            for (var _i = 0, scope_97 = scope; _i < scope_97.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_96, "$.message.order.items[*].category_id");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE(input) {
            ...
            for (var _i = 0, scope_98 = scope; _i < scope_98.length; _i++) {
                ...
                var enumList = ["Delivery", "Return", "RTO"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_97, "$.message.order.fulfillments[*].type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_5(input) {
            ...
            for (var _i = 0, scope_99 = scope; _i < scope_99.length; _i++) {
                ...
                var enumList = ["OTP"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_98, "$.message.order.fulfillments[*].start.authorization.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE(input) {
            ...
            for (var _i = 0, scope_100 = scope; _i < scope_100.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_99, "$.message.order.fulfillments[*].start.instructions.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_7(input) {
            ...
            for (var _i = 0, scope_101 = scope; _i < scope_101.length; _i++) {
                ...
                var enumList = ["OTP"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_100, "$.message.order.fulfillments[*].end.authorization.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE_8(input) {
            ...
            for (var _i = 0, scope_102 = scope; _i < scope_102.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_101, "$.message.order.fulfillments[*].end.instructions.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE_9(input) {
            ...
            for (var _i = 0, scope_103 = scope; _i < scope_103.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_102, "$.message.order.fulfillments[*].state.descriptor.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_10(input) {
            ...
            for (var _i = 0, scope_104 = scope; _i < scope_104.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_103, "$.message.order.payment.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_SETTLEMENT_COUNTERPARTY(input) {
            ...
            for (var _i = 0, scope_105 = scope; _i < scope_105.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_104, "$.message.order.payment['@ondc/org/settlement_details'][*].settlement_counterparty");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_BREAKUPONDCORGTITLE_TYPE(input) {
            ...
            for (var _i = 0, scope_106 = scope; _i < scope_106.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_105, "$.message.order.quote.breakup[*]['@ondc/org/title_type']");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function validate_tag_0(input) {
            ...
            for (var _i = 0, scope_107 = scope; _i < scope_107.length; _i++) {
                ...
                var validTags = ["type"];
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_106, "$.message.order.items[*].tags[*].code");
        ...
        function validate_tag_1(input) {
            ...
            for (var _i = 0, scope_109 = scope; _i < scope_109.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_108, "$.message.order.fulfillments[*].start.contact.tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_2(input) {
            ...
            for (var _i = 0, scope_111 = scope; _i < scope_111.length; _i++) {
                ...
                var validTags = ["masked_contact"];
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_110, "$.message.order.fulfillments[*].end.contact.tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_3(input) {
            ...
            for (var _i = 0, scope_113 = scope; _i < scope_113.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_112, "$.message.order.fulfillments[*].tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition validate_tag_3**: every element of $.message.order.fulfillments[*].tags[*].code must be in [\"linked_provider\", \"linked_order\", \"linked_order_item\", \"cod_settlement_detail\", \"fulfill_request\", \"fulfill_response\", \"state\", \"rto_action\", \"rto_verification\", \"shipping_label\", \"weather_check\"]\n\n\t> Note: **Condition validate_tag_3** can be skipped if the following conditions are met:\n\t>\n\t> - **condition B**: $.message.order.fulfillments[*].tags[*].code must **not** be present in the payload",
                        },
                    ];
                }
                delete testObj_112._EXTERNAL;
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition validate_tag_3_linked_provider**: every element of $.message.order.fulfillments[*].tags[?(@.code=='linked_provider')].list[*].code must be in [\"id\", \"name\", \"address\", \"tax_id\"]",
                        },
                    ];
                }
                delete testObj_113._EXTERNAL;
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition validate_tag_3_linked_order**: every element of $.message.order.fulfillments[*].tags[?(@.code=='linked_order')].list[*].code must be in [\"id\", \"cod_order\", \"collection_amount\", \"currency\", \"declared_value\", \"weight_unit\", \"weight_value\", \"dim_unit\", \"length\", \"breadth\", \"height\", \"shipment_type\"]",
                        },
                    ];
                }
                delete testObj_114._EXTERNAL;
        ...
        function validate_tag_3_shipping_label(input) {
        ...
        function validate_tag_3_weather_check(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$.message.order.fulfillments[*].tags[?(@.code=='weather_check')]");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_124 = scope; _i < scope_124.length; _i++) {
                var testObj_123 = scope_124[_i];
                testObj_123._EXTERNAL = input.externalData;
                var subTags = json_path_utils_1.default.getJsonPath(testObj_123, "$.list[*].code");
                var validValues = ["raining"];
                var validate = validation_utils_1.default.allIn(subTags, validValues);
                if (!validate) {
        ...
        function validate_tag_4(input) {
            ...
            for (var _i = 0, scope_125 = scope; _i < scope_125.length; _i++) {
                ...
                var validTags = ["bpp_terms", "bap_terms", "lbnp_sla_terms"];
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_124, "$.message.order.tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_4_bpp_terms(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$.message.order.tags[?(@.code=='bpp_terms')]");
            var subResults = [];
            var valid = true;
        ...
        function validate_tag_4_bap_terms(input) {
            ...
            for (var _i = 0, scope_127 = scope; _i < scope_127.length; _i++) {
                ...
                var subTags = json_path_utils_1.default.getJsonPath(testObj_126, "$.list[*].code");
        ...
        function validate_tag_4_lbnp_sla_terms(input) {
            ...
            for (var _i = 0, scope_128 = scope; _i < scope_128.length; _i++) {
                ...
                var subTags = json_path_utils_1.default.getJsonPath(testObj_127, "$.list[*].code");
                var validValues = [
                    "metric",
                    "base_unit",
                    "base_min",
        ...
        function on_confirm_fulfillment_id_validations(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_129 = scope; _i < scope_129.length; _i++) {
                ...
                function validate_fulfillment_id_in_items(input) {
                    ...
                    for (var _i = 0, scope_130 = scope; _i < scope_130.length; _i++) {
                        ...
                        var fulfillment_id = json_path_utils_1.default.getJsonPath(testObj_129, "$.message.order.items[*].fulfillment_id");
                        var fulfillment_ids = json_path_utils_1.default.getJsonPath(testObj_129, "$.message.order.items[*].fulfillment_ids[*]");
                ...
                function validate_fulfillment_id_in_fulfillments(input) {
                    ...
                    for (var _i = 0, scope_131 = scope; _i < scope_131.length; _i++) {
                        ...
                        var fulfillment_id = json_path_utils_1.default.getJsonPath(testObj_130, "$.message.order.fulfillments[*].id");
                        var item_fulfillment_id = json_path_utils_1.default.getJsonPath(testObj_130, "$.message.order.items[*].fulfillment_id");
                        var item_fulfillment_ids = json_path_utils_1.default.getJsonPath(testObj_130, "$.message.order.items[*].fulfillment_ids[*]");
