    ...
    for (var _i = 0, scope_1 = scope; _i < scope_1.length; _i++) {
        ...
        function REQUIRED_MESSAGE_START(input) {
            ...
            for (var _i = 0, scope_45 = scope; _i < scope_45.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_44, "$.message.order.fulfillments[*].start.time.range.start");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_END(input) {
            ...
            for (var _i = 0, scope_46 = scope; _i < scope_46.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_45, "$.message.order.fulfillments[*].start.time.range.end");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_NAME_46(input) {
            ...
            for (var _i = 0, scope_47 = scope; _i < scope_47.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_46, "$.message.order.fulfillments[*].end.person.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_GPS_47(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_48 = scope; _i < scope_48.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_47, "$.message.order.fulfillments[*].end.location.gps");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_NAME_48(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_49 = scope; _i < scope_49.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_48, "$.message.order.fulfillments[*].end.location.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_BUILDING_49(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_50 = scope; _i < scope_50.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_49, "$.message.order.fulfillments[*].end.location.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_LOCALITY_50(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_51 = scope; _i < scope_51.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_50, "$.message.order.fulfillments[*].end.location.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CITY_51(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_52 = scope; _i < scope_52.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_51, "$.message.order.fulfillments[*].end.location.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_STATE_52(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_53 = scope; _i < scope_53.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_52, "$.message.order.fulfillments[*].end.location.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_COUNTRY_53(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_54 = scope; _i < scope_54.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_53, "$.message.order.fulfillments[*].end.location.address.country");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_AREA_CODE_54(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_55 = scope; _i < scope_55.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_54, "$.message.order.fulfillments[*].end.location.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_PHONE_55(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_56 = scope; _i < scope_56.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_55, "$.message.order.fulfillments[*].end.contact.phone");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_START_56(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_57 = scope; _i < scope_57.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_56, "$.message.order.fulfillments[*].end.time.range.start");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_START_56**: $.message.order.fulfillments[*].end.time.range.start must be present in the payload",
                        },
                    ];
                }
                delete testObj_56._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_END_57(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_58 = scope; _i < scope_58.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_57, "$.message.order.fulfillments[*].end.time.range.end");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_END_57**: $.message.order.fulfillments[*].end.time.range.end must be present in the payload",
                        },
                    ];
                }
                delete testObj_57._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_58(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_59 = scope; _i < scope_59.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_58, "$.message.order.billing.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_58**: $.message.order.billing.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_58._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_59(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_60 = scope; _i < scope_60.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_59, "$.message.order.billing.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_59**: $.message.order.billing.address.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_59._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_BUILDING_60(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_61 = scope; _i < scope_61.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_60, "$.message.order.billing.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_BUILDING_60**: $.message.order.billing.address.building must be present in the payload",
                        },
                    ];
                }
                delete testObj_60._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_LOCALITY_61(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_62 = scope; _i < scope_62.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_61, "$.message.order.billing.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_LOCALITY_61**: $.message.order.billing.address.locality must be present in the payload",
                        },
                    ];
                }
                delete testObj_61._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CITY_62(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_63 = scope; _i < scope_63.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_62, "$.message.order.billing.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CITY_62**: $.message.order.billing.address.city must be present in the payload",
                        },
                    ];
                }
                delete testObj_62._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_STATE_63(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_64 = scope; _i < scope_64.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_63, "$.message.order.billing.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_STATE_63**: $.message.order.billing.address.state must be present in the payload",
                        },
                    ];
                }
                delete testObj_63._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_COUNTRY_64(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_65 = scope; _i < scope_65.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_64, "$.message.order.billing.address.country");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_COUNTRY_64**: $.message.order.billing.address.country must be present in the payload",
                        },
                    ];
                }
                delete testObj_64._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_AREA_CODE_65(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_66 = scope; _i < scope_66.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_65, "$.message.order.billing.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_AREA_CODE_65**: $.message.order.billing.address.area_code must be present in the payload",
                        },
                    ];
                }
                delete testObj_65._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_TAX_NUMBER(input) {
            ...
            for (var _i = 0, scope_67 = scope; _i < scope_67.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_66, "$.message.order.billing.tax_number");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_PHONE_67(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_68 = scope; _i < scope_68.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_67, "$.message.order.billing.phone");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_PHONE_67**: $.message.order.billing.phone must be present in the payload",
                        },
                    ];
                }
                delete testObj_67._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_EMAIL_68(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_69 = scope; _i < scope_69.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_68, "$.message.order.billing.email");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_EMAIL_68**: $.message.order.billing.email must be present in the payload",
                        },
                    ];
                }
                delete testObj_68._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CREATED_AT(input) {
            ...
            for (var _i = 0, scope_70 = scope; _i < scope_70.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_69, "$.message.order.billing.created_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_UPDATED_AT(input) {
            ...
            for (var _i = 0, scope_71 = scope; _i < scope_71.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_70, "$.message.order.billing.updated_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_COLLECTED_BY(input) {
            ...
            for (var _i = 0, scope_72 = scope; _i < scope_72.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_71, "$.message.order.payment.collected_by");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_TYPE_72(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_73 = scope; _i < scope_73.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_72, "$.message.order.payment.type");
                var enumList = [
                    "ON-ORDER",
                    "ON-FULFILLMENT",
                    "POST-FULFILLMENT",
        ...
        function REQUIRED_MESSAGE_CATEGORY_ID_73(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_74 = scope; _i < scope_74.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_73, "$.message.order['@ondc/org/linked_order'].items[*].category_id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CATEGORY_ID_73**: $.message.order['@ondc/org/linked_order'].items[*].category_id must be present in the payload",
                        },
                    ];
                }
                delete testObj_73._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_74(input) {
            ...
            for (var _i = 0, scope_75 = scope; _i < scope_75.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_74, "$.message.order['@ondc/org/linked_order'].items[*].descriptor.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_74**: $.message.order['@ondc/org/linked_order'].items[*].descriptor.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_74._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_COUNT(input) {
            ...
            for (var _i = 0, scope_76 = scope; _i < scope_76.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_75, "$.message.order['@ondc/org/linked_order'].items[*].quantity.count");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_UNIT(input) {
            ...
            for (var _i = 0, scope_77 = scope; _i < scope_77.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_76, "$.message.order['@ondc/org/linked_order'].items[*].quantity.measure.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_VALUE_77(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_78 = scope; _i < scope_78.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_77, "$.message.order['@ondc/org/linked_order'].items[*].quantity.measure.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_77**: $.message.order['@ondc/org/linked_order'].items[*].quantity.measure.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_77._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CURRENCY_78(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_79 = scope; _i < scope_79.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_78, "$.message.order['@ondc/org/linked_order'].items[*].price.currency");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CURRENCY_78**: $.message.order['@ondc/org/linked_order'].items[*].price.currency must be present in the payload",
                        },
                    ];
                }
                delete testObj_78._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_79(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_80 = scope; _i < scope_80.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_79, "$.message.order['@ondc/org/linked_order'].items[*].price.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_79**: $.message.order['@ondc/org/linked_order'].items[*].price.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_79._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_80(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_81 = scope; _i < scope_81.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_80, "$.message.order['@ondc/org/linked_order'].provider.descriptor.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_80**: $.message.order['@ondc/org/linked_order'].provider.descriptor.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_80._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_81(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_82 = scope; _i < scope_82.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_81, "$.message.order['@ondc/org/linked_order'].provider.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_81**: $.message.order['@ondc/org/linked_order'].provider.address.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_81._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_BUILDING_82(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_83 = scope; _i < scope_83.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_82, "$.message.order['@ondc/org/linked_order'].provider.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_BUILDING_82**: $.message.order['@ondc/org/linked_order'].provider.address.building must be present in the payload",
                        },
                    ];
                }
                delete testObj_82._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_LOCALITY_83(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_84 = scope; _i < scope_84.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_83, "$.message.order['@ondc/org/linked_order'].provider.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_LOCALITY_83**: $.message.order['@ondc/org/linked_order'].provider.address.locality must be present in the payload",
                        },
                    ];
                }
                delete testObj_83._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CITY_84(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_85 = scope; _i < scope_85.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_84, "$.message.order['@ondc/org/linked_order'].provider.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CITY_84**: $.message.order['@ondc/org/linked_order'].provider.address.city must be present in the payload",
                        },
                    ];
                }
                delete testObj_84._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_STATE_85(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_86 = scope; _i < scope_86.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_85, "$.message.order['@ondc/org/linked_order'].provider.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_STATE_85**: $.message.order['@ondc/org/linked_order'].provider.address.state must be present in the payload",
                        },
                    ];
                }
                delete testObj_85._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_AREA_CODE_86(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_87 = scope; _i < scope_87.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_86, "$.message.order['@ondc/org/linked_order'].provider.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_AREA_CODE_86**: $.message.order['@ondc/org/linked_order'].provider.address.area_code must be present in the payload",
                        },
                    ];
                }
                delete testObj_86._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_ID_87(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_88 = scope; _i < scope_88.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_87, "$.message.order['@ondc/org/linked_order'].order.id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_ID_87**: $.message.order['@ondc/org/linked_order'].order.id must be present in the payload",
                        },
                    ];
                }
                delete testObj_87._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_88(input) {
            ...
            for (var _i = 0, scope_89 = scope; _i < scope_89.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_88, "$.message.order['@ondc/org/linked_order'].order.weight.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_88**: $.message.order['@ondc/org/linked_order'].order.weight.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_88._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_89(input) {
            ...
            for (var _i = 0, scope_90 = scope; _i < scope_90.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_89, "$.message.order['@ondc/org/linked_order'].order.weight.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_89**: $.message.order['@ondc/org/linked_order'].order.weight.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_89._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_90(input) {
            ...
            for (var _i = 0, scope_91 = scope; _i < scope_91.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_90, "$.message.order['@ondc/org/linked_order'].order.dimensions.length.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_90**: $.message.order['@ondc/org/linked_order'].order.dimensions.length.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_90._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_91(input) {
            ...
            for (var _i = 0, scope_92 = scope; _i < scope_92.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_91, "$.message.order['@ondc/org/linked_order'].order.dimensions.length.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_91**: $.message.order['@ondc/org/linked_order'].order.dimensions.length.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_91._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_92(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_93 = scope; _i < scope_93.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_92, "$.message.order['@ondc/org/linked_order'].order.dimensions.breadth.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_92**: $.message.order['@ondc/org/linked_order'].order.dimensions.breadth.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_92._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_93(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_94 = scope; _i < scope_94.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_93, "$.message.order['@ondc/org/linked_order'].order.dimensions.breadth.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_93**: $.message.order['@ondc/org/linked_order'].order.dimensions.breadth.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_93._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_94(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_95 = scope; _i < scope_95.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_94, "$.message.order['@ondc/org/linked_order'].order.dimensions.height.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_94**: $.message.order['@ondc/org/linked_order'].order.dimensions.height.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_94._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_95(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_96 = scope; _i < scope_96.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_95, "$.message.order['@ondc/org/linked_order'].order.dimensions.height.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_95**: $.message.order['@ondc/org/linked_order'].order.dimensions.height.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_95._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UPDATED_AT_96(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_97 = scope; _i < scope_97.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_96, "$.message.order.updated_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UPDATED_AT_96**: $.message.order.updated_at must be present in the payload",
                        },
                    ];
                }
                delete testObj_96._EXTERNAL;
        ...
        function VALID_ENUM_CONTEXT_DOMAIN(input) {
            ...
            for (var _i = 0, scope_98 = scope; _i < scope_98.length; _i++) {
                ...
                var enumList = ["ONDC:LOG10", "ONDC:LOG11", "nic2004:60232"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_97, "$.context.domain");
        ...
        function VALID_ENUM_MESSAGE_STATE(input) {
            ...
            for (var _i = 0, scope_99 = scope; _i < scope_99.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_98, "$.message.order.state");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CATEGORY_ID(input) {
            ...
            for (var _i = 0, scope_100 = scope; _i < scope_100.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_99, "$.message.order.items[*].category_id");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE(input) {
            ...
            for (var _i = 0, scope_101 = scope; _i < scope_101.length; _i++) {
                ...
                var enumList = ["Delivery", "Return", "RTO"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_100, "$.message.order.fulfillments[*].type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_5(input) {
            ...
            for (var _i = 0, scope_102 = scope; _i < scope_102.length; _i++) {
                ...
                var enumList = ["OTP"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_101, "$.message.order.fulfillments[*].start.authorization.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE(input) {
            ...
            for (var _i = 0, scope_103 = scope; _i < scope_103.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_102, "$.message.order.fulfillments[*].start.instructions.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_7(input) {
            ...
            for (var _i = 0, scope_104 = scope; _i < scope_104.length; _i++) {
                ...
                var enumList = ["OTP"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_103, "$.message.order.fulfillments[*].end.authorization.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE_8(input) {
            ...
            for (var _i = 0, scope_105 = scope; _i < scope_105.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_104, "$.message.order.fulfillments[*].end.instructions.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE_9(input) {
            ...
            for (var _i = 0, scope_106 = scope; _i < scope_106.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_105, "$.message.order.fulfillments[*].state.descriptor.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_10(input) {
            ...
            for (var _i = 0, scope_107 = scope; _i < scope_107.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_106, "$.message.order.payment.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_SETTLEMENT_COUNTERPARTY(input) {
            ...
            for (var _i = 0, scope_108 = scope; _i < scope_108.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_107, "$.message.order.payment['@ondc/org/settlement_details'][*].settlement_counterparty");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_BREAKUPONDCORGTITLE_TYPE(input) {
            ...
            for (var _i = 0, scope_109 = scope; _i < scope_109.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_108, "$.message.order.quote.breakup[*]['@ondc/org/title_type']");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function validate_tag_0(input) {
            ...
            for (var _i = 0, scope_110 = scope; _i < scope_110.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_109, "$.message.order.fulfillments[*].start.contact.tags[*].code");
        ...
        function validate_tag_1(input) {
            ...
            for (var _i = 0, scope_112 = scope; _i < scope_112.length; _i++) {
                ...
                var validTags = ["masked_contact"];
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_111, "$.message.order.fulfillments[*].end.contact.tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_2(input) {
            ...
            for (var _i = 0, scope_114 = scope; _i < scope_114.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_113, "$.message.order.fulfillments[*].tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
