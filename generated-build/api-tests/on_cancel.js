...
function on_cancel(input) {
    ...
    for (var _i = 0, scope_1 = scope; _i < scope_1.length; _i++) {
        ...
        function REQUIRED_MESSAGE_CANCELLED_BY(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_16 = scope; _i < scope_16.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_15, "$.message.order.cancellation.cancelled_by");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_ID_16(input) {
            ...
            for (var _i = 0, scope_17 = scope; _i < scope_17.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_16, "$.message.order.cancellation.reason.id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_ID_17(input) {
            ...
            for (var _i = 0, scope_18 = scope; _i < scope_18.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_17, "$.message.order.provider.id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_ID_18(input) {
            ...
            for (var _i = 0, scope_19 = scope; _i < scope_19.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_18, "$.message.order.items[*].id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CATEGORY_ID(input) {
            ...
            for (var _i = 0, scope_20 = scope; _i < scope_20.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_19, "$.message.order.items[*].category_id");
                var enumList = [
                    "Express Delivery",
                    "Standard Delivery",
                    "Immediate Delivery",
        ...
        function REQUIRED_MESSAGE_LABEL(input) {
            ...
            for (var _i = 0, scope_21 = scope; _i < scope_21.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_20, "$.message.order.items[*].time.label");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_DURATION(input) {
            ...
            for (var _i = 0, scope_22 = scope; _i < scope_22.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_21, "$.message.order.items[*].time.duration");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_TIMESTAMP(input) {
            ...
            for (var _i = 0, scope_23 = scope; _i < scope_23.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_22, "$.message.order.items[*].time.timestamp");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CURRENCY(input) {
            ...
            for (var _i = 0, scope_24 = scope; _i < scope_24.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_23, "$.message.order.quote.price.currency");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_VALUE(input) {
            ...
            for (var _i = 0, scope_25 = scope; _i < scope_25.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_24, "$.message.order.quote.price.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_BREAKUPONDCORGITEM_ID(input) {
            ...
            for (var _i = 0, scope_26 = scope; _i < scope_26.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_25, "$.message.order.quote.breakup[*]['@ondc/org/item_id']");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_BREAKUPONDCORGTITLE_TYPE(input) {
            ...
            for (var _i = 0, scope_27 = scope; _i < scope_27.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_26, "$.message.order.quote.breakup[*]['@ondc/org/title_type']");
                var enumList = [
                    "delivery",
                    "rto",
                    "tax",
        ...
        function REQUIRED_MESSAGE_CURRENCY_27(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_28 = scope; _i < scope_28.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_27, "$.message.order.quote.breakup[*].price.currency");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_VALUE_28(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_29 = scope; _i < scope_29.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_28, "$.message.order.quote.breakup[*].price.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_ID_29(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_30 = scope; _i < scope_30.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_29, "$.message.order.fulfillments[*].id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_TYPE(input) {
            ...
            for (var _i = 0, scope_31 = scope; _i < scope_31.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_30, "$.message.order.fulfillments[*].type");
        ...
        function REQUIRED_MESSAGE_CODE(input) {
            ...
            for (var _i = 0, scope_32 = scope; _i < scope_32.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_31, "$.message.order.fulfillments[*].state.descriptor.code");
                var enumList = [
                    "Pending",
                    "Cancelled",
                    "Order-picked-up",
        ...
        function REQUIRED_MESSAGE_TYPE_32(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_33 = scope; _i < scope_33.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_32, "$.message.order.payment.type");
                var enumList = [
                    "ON-ORDER",
                    "ON-FULFILLMENT",
                    "POST-FULFILLMENT",
        ...
        function REQUIRED_MESSAGE_COLLECTED_BY(input) {
            ...
            for (var _i = 0, scope_34 = scope; _i < scope_34.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_33, "$.message.order.payment.collected_by");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_STATUS(input) {
            ...
            for (var _i = 0, scope_35 = scope; _i < scope_35.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_34, "$.message.order.payment.status");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_NAME(input) {
            ...
            for (var _i = 0, scope_36 = scope; _i < scope_36.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_35, "$.message.order.billing.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_NAME_36(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_37 = scope; _i < scope_37.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_36, "$.message.order.billing.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_36**: $.message.order.billing.address.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_36._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_BUILDING(input) {
            ...
            for (var _i = 0, scope_38 = scope; _i < scope_38.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_37, "$.message.order.billing.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_LOCALITY(input) {
            ...
            for (var _i = 0, scope_39 = scope; _i < scope_39.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_38, "$.message.order.billing.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CITY(input) {
            ...
            for (var _i = 0, scope_40 = scope; _i < scope_40.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_39, "$.message.order.billing.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_STATE_40(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_41 = scope; _i < scope_41.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_40, "$.message.order.billing.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_STATE_40**: $.message.order.billing.address.state must be present in the payload",
                        },
                    ];
                }
                delete testObj_40._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_COUNTRY(input) {
            ...
            for (var _i = 0, scope_42 = scope; _i < scope_42.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_41, "$.message.order.billing.address.country");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_AREA_CODE(input) {
            ...
            for (var _i = 0, scope_43 = scope; _i < scope_43.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_42, "$.message.order.billing.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_TAX_NUMBER(input) {
            ...
            for (var _i = 0, scope_44 = scope; _i < scope_44.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_43, "$.message.order.billing.tax_number");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_PHONE(input) {
            ...
            for (var _i = 0, scope_45 = scope; _i < scope_45.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_44, "$.message.order.billing.phone");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_EMAIL(input) {
            ...
            for (var _i = 0, scope_46 = scope; _i < scope_46.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_45, "$.message.order.billing.email");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CREATED_AT(input) {
            ...
            for (var _i = 0, scope_47 = scope; _i < scope_47.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_46, "$.message.order.billing.created_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_UPDATED_AT(input) {
            ...
            for (var _i = 0, scope_48 = scope; _i < scope_48.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_47, "$.message.order.billing.updated_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CATEGORY_ID_48(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_49 = scope; _i < scope_49.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_48, "$.message.order['@ondc/org/linked_order'].items[*].category_id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CATEGORY_ID_48**: $.message.order['@ondc/org/linked_order'].items[*].category_id must be present in the payload",
                        },
                    ];
                }
                delete testObj_48._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_49(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_50 = scope; _i < scope_50.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_49, "$.message.order['@ondc/org/linked_order'].items[*].descriptor.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_49**: $.message.order['@ondc/org/linked_order'].items[*].descriptor.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_49._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_COUNT(input) {
            ...
            for (var _i = 0, scope_51 = scope; _i < scope_51.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_50, "$.message.order['@ondc/org/linked_order'].items[*].quantity.count");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_UNIT(input) {
            ...
            for (var _i = 0, scope_52 = scope; _i < scope_52.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_51, "$.message.order['@ondc/org/linked_order'].items[*].quantity.measure.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_VALUE_52(input) {
            ...
            for (var _i = 0, scope_53 = scope; _i < scope_53.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_52, "$.message.order['@ondc/org/linked_order'].items[*].quantity.measure.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_52**: $.message.order['@ondc/org/linked_order'].items[*].quantity.measure.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_52._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CURRENCY_53(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_54 = scope; _i < scope_54.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_53, "$.message.order['@ondc/org/linked_order'].items[*].price.currency");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CURRENCY_53**: $.message.order['@ondc/org/linked_order'].items[*].price.currency must be present in the payload",
                        },
                    ];
                }
                delete testObj_53._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_54(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_55 = scope; _i < scope_55.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_54, "$.message.order['@ondc/org/linked_order'].items[*].price.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_54**: $.message.order['@ondc/org/linked_order'].items[*].price.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_54._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_55(input) {
            ...
            for (var _i = 0, scope_56 = scope; _i < scope_56.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_55, "$.message.order['@ondc/org/linked_order'].provider.descriptor.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_55**: $.message.order['@ondc/org/linked_order'].provider.descriptor.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_55._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_NAME_56(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_57 = scope; _i < scope_57.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_56, "$.message.order['@ondc/org/linked_order'].provider.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_NAME_56**: $.message.order['@ondc/org/linked_order'].provider.address.name must be present in the payload",
                        },
                    ];
                }
                delete testObj_56._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_BUILDING_57(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_58 = scope; _i < scope_58.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_57, "$.message.order['@ondc/org/linked_order'].provider.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_BUILDING_57**: $.message.order['@ondc/org/linked_order'].provider.address.building must be present in the payload",
                        },
                    ];
                }
                delete testObj_57._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_LOCALITY_58(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_59 = scope; _i < scope_59.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_58, "$.message.order['@ondc/org/linked_order'].provider.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_LOCALITY_58**: $.message.order['@ondc/org/linked_order'].provider.address.locality must be present in the payload",
                        },
                    ];
                }
                delete testObj_58._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_CITY_59(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_60 = scope; _i < scope_60.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_59, "$.message.order['@ondc/org/linked_order'].provider.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_CITY_59**: $.message.order['@ondc/org/linked_order'].provider.address.city must be present in the payload",
                        },
                    ];
                }
                delete testObj_59._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_STATE_60(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_61 = scope; _i < scope_61.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_60, "$.message.order['@ondc/org/linked_order'].provider.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_STATE_60**: $.message.order['@ondc/org/linked_order'].provider.address.state must be present in the payload",
                        },
                    ];
                }
                delete testObj_60._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_AREA_CODE_61(input) {
            ...
            for (var _i = 0, scope_62 = scope; _i < scope_62.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_61, "$.message.order['@ondc/org/linked_order'].provider.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_AREA_CODE_61**: $.message.order['@ondc/org/linked_order'].provider.address.area_code must be present in the payload",
                        },
                    ];
                }
                delete testObj_61._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_ID_62(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_63 = scope; _i < scope_63.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_62, "$.message.order['@ondc/org/linked_order'].order.id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_ID_62**: $.message.order['@ondc/org/linked_order'].order.id must be present in the payload",
                        },
                    ];
                }
                delete testObj_62._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_63(input) {
            ...
            for (var _i = 0, scope_64 = scope; _i < scope_64.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_63, "$.message.order['@ondc/org/linked_order'].order.weight.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_63**: $.message.order['@ondc/org/linked_order'].order.weight.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_63._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_64(input) {
            ...
            for (var _i = 0, scope_65 = scope; _i < scope_65.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_64, "$.message.order['@ondc/org/linked_order'].order.weight.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_64**: $.message.order['@ondc/org/linked_order'].order.weight.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_64._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_65(input) {
            ...
            for (var _i = 0, scope_66 = scope; _i < scope_66.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_65, "$.message.order['@ondc/org/linked_order'].order.dimensions.length.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_65**: $.message.order['@ondc/org/linked_order'].order.dimensions.length.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_65._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_66(input) {
            ...
            for (var _i = 0, scope_67 = scope; _i < scope_67.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_66, "$.message.order['@ondc/org/linked_order'].order.dimensions.length.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_66**: $.message.order['@ondc/org/linked_order'].order.dimensions.length.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_66._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_67(input) {
            ...
            for (var _i = 0, scope_68 = scope; _i < scope_68.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_67, "$.message.order['@ondc/org/linked_order'].order.dimensions.breadth.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_67**: $.message.order['@ondc/org/linked_order'].order.dimensions.breadth.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_67._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_68(input) {
            ...
            for (var _i = 0, scope_69 = scope; _i < scope_69.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_68, "$.message.order['@ondc/org/linked_order'].order.dimensions.breadth.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_68**: $.message.order['@ondc/org/linked_order'].order.dimensions.breadth.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_68._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UNIT_69(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_70 = scope; _i < scope_70.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_69, "$.message.order['@ondc/org/linked_order'].order.dimensions.height.unit");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UNIT_69**: $.message.order['@ondc/org/linked_order'].order.dimensions.height.unit must be present in the payload",
                        },
                    ];
                }
                delete testObj_69._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_VALUE_70(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_71 = scope; _i < scope_71.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_70, "$.message.order['@ondc/org/linked_order'].order.dimensions.height.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_VALUE_70**: $.message.order['@ondc/org/linked_order'].order.dimensions.height.value must be present in the payload",
                        },
                    ];
                }
                delete testObj_70._EXTERNAL;
        ...
        function REQUIRED_MESSAGE_UPDATED_AT_71(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_72 = scope; _i < scope_72.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_71, "$.message.order.updated_at");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition REQUIRED_MESSAGE_UPDATED_AT_71**: $.message.order.updated_at must be present in the payload",
                        },
                    ];
                }
                delete testObj_71._EXTERNAL;
        ...
        function VALID_ENUM_CONTEXT_DOMAIN(input) {
            ...
            for (var _i = 0, scope_73 = scope; _i < scope_73.length; _i++) {
                ...
                var enumList = ["ONDC:LOG10", "ONDC:LOG11", "nic2004:60232"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_72, "$.context.domain");
        ...
        function VALID_ENUM_MESSAGE_STATE(input) {
            ...
            for (var _i = 0, scope_74 = scope; _i < scope_74.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_73, "$.message.order.state");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CATEGORY_ID(input) {
            ...
            for (var _i = 0, scope_75 = scope; _i < scope_75.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_74, "$.message.order.items[*].category_id");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE(input) {
            ...
            for (var _i = 0, scope_76 = scope; _i < scope_76.length; _i++) {
                ...
                var enumList = ["Delivery", "Return", "RTO"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_75, "$.message.order.fulfillments[*].type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_5(input) {
            ...
            for (var _i = 0, scope_77 = scope; _i < scope_77.length; _i++) {
                ...
                var enumList = ["OTP"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_76, "$.message.order.fulfillments[*].start.authorization.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE(input) {
            ...
            for (var _i = 0, scope_78 = scope; _i < scope_78.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_77, "$.message.order.fulfillments[*].start.instructions.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_7(input) {
            ...
            for (var _i = 0, scope_79 = scope; _i < scope_79.length; _i++) {
                ...
                var enumList = ["OTP"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_78, "$.message.order.fulfillments[*].end.authorization.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE_8(input) {
            ...
            for (var _i = 0, scope_80 = scope; _i < scope_80.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_79, "$.message.order.fulfillments[*].end.instructions.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_CODE_9(input) {
            ...
            for (var _i = 0, scope_81 = scope; _i < scope_81.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_80, "$.message.order.fulfillments[*].state.descriptor.code");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_10(input) {
            ...
            for (var _i = 0, scope_82 = scope; _i < scope_82.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_81, "$.message.order.payment.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_SETTLEMENT_COUNTERPARTY(input) {
            ...
            for (var _i = 0, scope_83 = scope; _i < scope_83.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_82, "$.message.order.payment['@ondc/org/settlement_details'][*].settlement_counterparty");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_BREAKUPONDCORGTITLE_TYPE(input) {
            ...
            for (var _i = 0, scope_84 = scope; _i < scope_84.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_83, "$.message.order.quote.breakup[*]['@ondc/org/title_type']");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function validate_tag_0(input) {
            ...
            for (var _i = 0, scope_85 = scope; _i < scope_85.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_84, "$.message.order.fulfillments[*].start.contact.tags[*].code");
        ...
        function validate_tag_1(input) {
            ...
            for (var _i = 0, scope_87 = scope; _i < scope_87.length; _i++) {
                ...
                var validTags = ["masked_contact"];
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_86, "$.message.order.fulfillments[*].end.contact.tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_2(input) {
            ...
            for (var _i = 0, scope_89 = scope; _i < scope_89.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_88, "$.message.order.fulfillments[*].tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_2_igm_request(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$.message.order.fulfillments[*].tags[?(@.code=='igm_request')]");
            var subResults = [];
            var valid = true;
        ...
        function order_picked_up_timestamp(input) {
            ...
            for (var _i = 0, scope_105 = scope; _i < scope_105.length; _i++) {
                ...
                var pickupTimestamp = json_path_utils_1.default.getJsonPath(testObj_104, "$.message.order.fulfillments[?(@.type=='Delivery')].start.time.timestamp");
                var fulfillmentState = json_path_utils_1.default.getJsonPath(testObj_104, "$.message.order.fulfillments[?(@.type=='Delivery')].state.descriptor.code");
                var state = ["RTO"];
        ...
        function rto_initiated_timestamp(input) {
            ...
            for (var _i = 0, scope_106 = scope; _i < scope_106.length; _i++) {
                ...
                var rtoInitiatedTimestamp = json_path_utils_1.default.getJsonPath(testObj_105, "$.message.order.fulfillments[?(@.type=='RTO')].start.time.timestamp");
                var fulfillmentState = json_path_utils_1.default.getJsonPath(testObj_105, "$.message.order.fulfillments[?(@.type=='RTO')].state.descriptor.code");
        ...
        function rto_event_tag_validation(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_107 = scope; _i < scope_107.length; _i++) {
                ...
                var rtoEventTag = json_path_utils_1.default.getJsonPath(testObj_106, "$.message.order.fulfillments[?(@.type=='Delivery')].tags[?(@.code=='rto_event')].code");
                var fulfillmentState = json_path_utils_1.default.getJsonPath(testObj_106, "$.message.order.fulfillments[?(@.type=='Delivery')].state.descriptor.code");
                var state = ["RTO"];
                var skipCheck = !validation_utils_1.default.allIn(fulfillmentState, state);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.arePresent(rtoEventTag);
                if (!validate) {
        ...
        function start_address_validations(input) {
            ...
            for (var _i = 0, scope_108 = scope; _i < scope_108.length; _i++) {
                ...
                var startLocation = json_path_utils_1.default.getJsonPath(testObj_107, "$.message.order.fulfillments[?(@.type=='Delivery')].start.location.address.city");
        ...
        function end_address_validations(input) {
            ...
            for (var _i = 0, scope_109 = scope; _i < scope_109.length; _i++) {
                ...
                var endLocation = json_path_utils_1.default.getJsonPath(testObj_108, "$.message.order.fulfillments[?(@.type=='Delivery')].end.location.address.city");
