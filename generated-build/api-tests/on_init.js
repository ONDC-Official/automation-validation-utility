    ...
    for (var _i = 0, scope_1 = scope; _i < scope_1.length; _i++) {
        ...
        function REQUIRED_MESSAGE_ID(input) {
            ...
            for (var _i = 0, scope_14 = scope; _i < scope_14.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_13, "$.message.order.items[*].id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_ID_14(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_15 = scope; _i < scope_15.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_14, "$.message.order.fulfillments[*].id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_TYPE(input) {
            ...
            for (var _i = 0, scope_16 = scope; _i < scope_16.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_15, "$.message.order.fulfillments[*].type");
        ...
        function REQUIRED_MESSAGE_ID_16(input) {
            ...
            for (var _i = 0, scope_17 = scope; _i < scope_17.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_16, "$.message.order.fulfillments[*].start.location.id");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_GPS(input) {
            ...
            for (var _i = 0, scope_18 = scope; _i < scope_18.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_17, "$.message.order.fulfillments[*].start.location.gps");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_NAME(input) {
            ...
            for (var _i = 0, scope_19 = scope; _i < scope_19.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_18, "$.message.order.fulfillments[*].start.location.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_BUILDING(input) {
            ...
            for (var _i = 0, scope_20 = scope; _i < scope_20.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_19, "$.message.order.fulfillments[*].start.location.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_LOCALITY(input) {
            ...
            for (var _i = 0, scope_21 = scope; _i < scope_21.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_20, "$.message.order.fulfillments[*].start.location.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CITY(input) {
            ...
            for (var _i = 0, scope_22 = scope; _i < scope_22.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_21, "$.message.order.fulfillments[*].start.location.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_STATE(input) {
            ...
            for (var _i = 0, scope_23 = scope; _i < scope_23.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_22, "$.message.order.fulfillments[*].start.location.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_COUNTRY(input) {
            ...
            for (var _i = 0, scope_24 = scope; _i < scope_24.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_23, "$.message.order.fulfillments[*].start.location.address.country");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_AREA_CODE(input) {
            ...
            for (var _i = 0, scope_25 = scope; _i < scope_25.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_24, "$.message.order.fulfillments[*].start.location.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_PHONE(input) {
            ...
            for (var _i = 0, scope_26 = scope; _i < scope_26.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_25, "$.message.order.fulfillments[*].start.contact.phone");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_EMAIL(input) {
            ...
            for (var _i = 0, scope_27 = scope; _i < scope_27.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_26, "$.message.order.fulfillments[*].start.contact.email");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_GPS_27(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_28 = scope; _i < scope_28.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_27, "$.message.order.fulfillments[*].end.location.gps");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_NAME_28(input) {
            ...
            for (var _i = 0, scope_29 = scope; _i < scope_29.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_28, "$.message.order.fulfillments[*].end.location.address.name");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_BUILDING_29(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_30 = scope; _i < scope_30.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_29, "$.message.order.fulfillments[*].end.location.address.building");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_LOCALITY_30(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_31 = scope; _i < scope_31.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_30, "$.message.order.fulfillments[*].end.location.address.locality");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CITY_31(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_32 = scope; _i < scope_32.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_31, "$.message.order.fulfillments[*].end.location.address.city");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_STATE_32(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_33 = scope; _i < scope_33.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_32, "$.message.order.fulfillments[*].end.location.address.state");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_COUNTRY_33(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_34 = scope; _i < scope_34.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_33, "$.message.order.fulfillments[*].end.location.address.country");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_AREA_CODE_34(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_35 = scope; _i < scope_35.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_34, "$.message.order.fulfillments[*].end.location.address.area_code");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_PHONE_35(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_36 = scope; _i < scope_36.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_35, "$.message.order.fulfillments[*].end.contact.phone");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_CURRENCY(input) {
            ...
            for (var _i = 0, scope_37 = scope; _i < scope_37.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_36, "$.message.order.quote.price.currency");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_VALUE(input) {
            ...
            for (var _i = 0, scope_38 = scope; _i < scope_38.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_37, "$.message.order.quote.price.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_BREAKUPONDCORGITEM_ID(input) {
            ...
            for (var _i = 0, scope_39 = scope; _i < scope_39.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_38, "$.message.order.quote.breakup[*]['@ondc/org/item_id']");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_BREAKUPONDCORGTITLE_TYPE(input) {
            ...
            for (var _i = 0, scope_40 = scope; _i < scope_40.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_39, "$.message.order.quote.breakup[*]['@ondc/org/title_type']");
                var enumList = [
                    "delivery",
                    "rto",
                    "tax",
        ...
        function REQUIRED_MESSAGE_CURRENCY_40(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_41 = scope; _i < scope_41.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_40, "$.message.order.quote.breakup[*].price.currency");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_VALUE_41(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_42 = scope; _i < scope_42.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_41, "$.message.order.quote.breakup[*].price.value");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_TTL(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_43 = scope; _i < scope_43.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_42, "$.message.order.quote.ttl");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function REQUIRED_MESSAGE_TYPE_43(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_44 = scope; _i < scope_44.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_43, "$.message.order.payment.type");
                var enumList = [
                    "ON-ORDER",
                    "ON-FULFILLMENT",
                    "POST-FULFILLMENT",
        ...
        function REQUIRED_MESSAGE_COLLECTED_BY(input) {
            ...
            for (var _i = 0, scope_45 = scope; _i < scope_45.length; _i++) {
                ...
                var attr = json_path_utils_1.default.getJsonPath(testObj_44, "$.message.order.payment.collected_by");
                var validate = validation_utils_1.default.arePresent(attr);
                if (!validate) {
        ...
        function VALID_ENUM_CONTEXT_DOMAIN(input) {
            ...
            for (var _i = 0, scope_46 = scope; _i < scope_46.length; _i++) {
                ...
                var enumList = ["ONDC:LOG10", "ONDC:LOG11", "nic2004:60232"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_45, "$.context.domain");
        ...
        function VALID_ENUM_MESSAGE_TYPE(input) {
            ...
            for (var _i = 0, scope_47 = scope; _i < scope_47.length; _i++) {
                ...
                var enumList = ["Delivery", "Return", "RTO"];
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_46, "$.message.order.fulfillments[*].type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_TYPE_3(input) {
            ...
            for (var _i = 0, scope_48 = scope; _i < scope_48.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_47, "$.message.order.payment.type");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_SETTLEMENT_COUNTERPARTY(input) {
            ...
            for (var _i = 0, scope_49 = scope; _i < scope_49.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_48, "$.message.order.payment['@ondc/org/settlement_details'][*].settlement_counterparty");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function VALID_ENUM_MESSAGE_BREAKUPONDCORGTITLE_TYPE(input) {
            ...
            for (var _i = 0, scope_50 = scope; _i < scope_50.length; _i++) {
                ...
                var enumPath = json_path_utils_1.default.getJsonPath(testObj_49, "$.message.order.quote.breakup[*]['@ondc/org/title_type']");
                var skipCheck = !validation_utils_1.default.arePresent(enumPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(enumPath, enumList);
        ...
        function validate_tag_0(input) {
            ...
            for (var _i = 0, scope_51 = scope; _i < scope_51.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_50, "$.message.order.fulfillments[*].start.contact.tags[*].code");
        ...
        function validate_tag_0_masked_contact(input) {
            ...
            for (var _i = 0, scope_52 = scope; _i < scope_52.length; _i++) {
                ...
                var subTags = json_path_utils_1.default.getJsonPath(testObj_51, "$.list[*].code");
        ...
        function validate_tag_1(input) {
            ...
            for (var _i = 0, scope_53 = scope; _i < scope_53.length; _i++) {
                ...
                var validTags = ["masked_contact"];
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_52, "$.message.order.fulfillments[*].end.contact.tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_1_masked_contact(input) {
            ...
            for (var _i = 0, scope_54 = scope; _i < scope_54.length; _i++) {
                ...
                var subTags = json_path_utils_1.default.getJsonPath(testObj_53, "$.list[*].code");
                var validValues = ["type", "setup", "token"];
                var validate = validation_utils_1.default.allIn(subTags, validValues);
                if (!validate) {
        ...
        function validate_tag_2(input) {
            ...
            for (var _i = 0, scope_55 = scope; _i < scope_55.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_54, "$.message.order.fulfillments[*].tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_2_rider_check(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$.message.order.fulfillments[*].tags[?(@.code=='rider_check')]");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_56 = scope; _i < scope_56.length; _i++) {
                var testObj_55 = scope_56[_i];
                testObj_55._EXTERNAL = input.externalData;
                var subTags = json_path_utils_1.default.getJsonPath(testObj_55, "$.list[*].code");
                var validValues = ["inline_check_for_rider"];
                var validate = validation_utils_1.default.allIn(subTags, validValues);
                if (!validate) {
        ...
        function validate_tag_2_linked_provider(input) {
            ...
            for (var _i = 0, scope_57 = scope; _i < scope_57.length; _i++) {
                ...
                var subTags = json_path_utils_1.default.getJsonPath(testObj_56, "$.list[*].code");
        ...
        function validate_tag_2_fulfill_request(input) {
            ...
            for (var _i = 0, scope_58 = scope; _i < scope_58.length; _i++) {
                ...
                var subTags = json_path_utils_1.default.getJsonPath(testObj_57, "$.list[*].code");
                var validValues = [
                    "rider_count",
                    "order_count",
                    "rate_basis",
        ...
        function validate_tag_2_linked_order(input) {
            ...
            for (var _i = 0, scope_60 = scope; _i < scope_60.length; _i++) {
                ...
                var subTags = json_path_utils_1.default.getJsonPath(testObj_59, "$.list[*].code");
                var validValues = [
                    "id",
                    "cod_order",
                    "collection_amount",
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: "- **condition validate_tag_2_linked_order**: every element of $.message.order.fulfillments[*].tags[?(@.code=='linked_order')].list[*].code must be in [\"id\", \"cod_order\", \"collection_amount\", \"currency\", \"declared_value\", \"weight_unit\", \"weight_value\", \"dim_unit\", \"length\", \"breadth\", \"height\"]",
                        },
                    ];
                }
                delete testObj_59._EXTERNAL;
        ...
        function validate_tag_3(input) {
            ...
            for (var _i = 0, scope_62 = scope; _i < scope_62.length; _i++) {
                ...
                var tagPath = json_path_utils_1.default.getJsonPath(testObj_61, "$.message.order.tags[*].code");
                var skipCheck = !validation_utils_1.default.arePresent(tagPath);
                if (skipCheck)
                    continue;
                var validate = validation_utils_1.default.allIn(tagPath, validTags);
        ...
        function validate_tag_3_bpp_terms(input) {
        ...
        function on_init_fulfillment_id_validations(input) {
            var scope = json_path_utils_1.default.getJsonPath(input.payload, "$");
            var subResults = [];
            var valid = true;
            for (var _i = 0, scope_64 = scope; _i < scope_64.length; _i++) {
                ...
                function validate_fulfillment_id_in_items(input) {
                    ...
                    for (var _i = 0, scope_65 = scope; _i < scope_65.length; _i++) {
                        ...
                        var fulfillment_id = json_path_utils_1.default.getJsonPath(testObj_64, "$.message.order.items[*].fulfillment_id");
                        var fulfillment_ids = json_path_utils_1.default.getJsonPath(testObj_64, "$.message.order.items[*].fulfillment_ids[*]");
                ...
                function validate_fulfillment_id_in_fulfillments(input) {
                    ...
                    for (var _i = 0, scope_66 = scope; _i < scope_66.length; _i++) {
                        ...
                        var fulfillment_id = json_path_utils_1.default.getJsonPath(testObj_65, "$.message.order.fulfillments[*].id");
                        var item_fulfillment_id = json_path_utils_1.default.getJsonPath(testObj_65, "$.message.order.items[*].fulfillment_id");
                        var item_fulfillment_ids = json_path_utils_1.default.getJsonPath(testObj_65, "$.message.order.items[*].fulfillment_ids[*]");
